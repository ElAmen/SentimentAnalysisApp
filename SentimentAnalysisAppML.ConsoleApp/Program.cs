...
namespace SentimentAnalysisAppML.ConsoleApp
{
    class Program
    {
        ...
        private const string DATA_FILEPATH = @"C:\Users\Amen\Downloads\wikipedia-detox-250-line-data.tsv";
        ...
        private static ModelInput CreateSingleDataSample(string dataFilePath)
        {
            ...
            sampleForPrediction = new ModelInput { Sentiment = true, SentimentText = ":::::I'm sure also." };
