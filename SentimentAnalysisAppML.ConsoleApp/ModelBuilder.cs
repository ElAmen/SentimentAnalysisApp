...
using SentimentAnalysisAppML.Model;

namespace SentimentAnalysisAppML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\Amen\Downloads\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"../../../../SentimentAnalysisAppML.Model/MLModel.zip";
